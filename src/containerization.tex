...
\begin{document}
    ...
    \input{containerization/sections/introduction}
    \input{containerization/sections/virtualization}
    \input{containerization/sections/containerization}
    \input{containerization/sections/questions}
    \input{containerization/sections/references}
\end{document}